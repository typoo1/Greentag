...
##        print("You are using an invalid version of Chrome, please update to version 74, 79, or 80")
##        time.sleep(600)
...
##            i += 1
        ...
        try:
            ...
            print("Something went wrong with your config file, either edit it or delete it to have the script replace it.")
            time.sleep(600)
...
"""
Checks if the user wants to beging filling out SNOW forms, then opens a test browser to verify all chrome settings are correct and versions match appropriately. 
"""
