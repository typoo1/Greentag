                        ...
                        if sdate[:-15] == str(tarDate):
                            ...
                            while i < len(strings):
                                if(re.search(Park2c, strings[i]) or re.search(Park2m, strings[i]) or re.search(Park1c, strings[i]) or re.search(Park1MPR, strings[i]) or re.search(Park2MPR, strings[i])
                                    ...
                                    z = i
                                    statSet = False
                                    if(re.search(Park2QQ, strings[i]) or re.search(Park1QQ, strings[i]) or re.search(Park1MPR, strings[i]) or re.search(Park2MPR, strings[i])): #If MPR
                                    ...
                                    if(re.search(Park2c, strings[i]) or re.search(Park1c, strings[i])): #If Culinary
                                        while z < len(strings) and z < i + 20:
                                            ...
                                            if(strings[z] == "%"): #Detect if register is from FreedomPay report dynamically
                                               if(float(strings[z-1]) < 20):
                                                    ...
                                                    break
                                               if(strings[z-5] == "6" or strings[z-6] == "6"):
                                                    registers.append(Register(strings[i], "Repl problem", 103))
                                                    break
                                               registers.append(Register(strings[i], status, 25))
                                               break
                                            z+=1
                                    if(re.search(Park2m, strings[i]) or re.search(Park1m, strings[i])): #If Xstore
                                        statSet = False
                                        while z < len(strings) and z < i + 20:
                                            if(strings[z].lower() == "online" or strings[z].lower() == "offline" or strings[z].lower() == "off" or z + 1 == len(strings)):
                                                ...
                                                if(statSet): #should only trigger on xstore registers
                                                    if(strings[z-1].lower() == "failed"):
                                                        registers.append(Register(strings[i], "Close Failure", 105))
